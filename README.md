...
<!-- PROGRESS:BADGE -->
![matched](https://img.shields.io/badge/matched-327%2F3713%20(8.81%25)-1f6feb)
<!-- /PROGRESS:BADGE -->
...
|---|---:|---:|---|
| **Main executable** (`KKND.EXE`) | 3713 | 327 | `▰▰▱▱▱▱▱▱▱▱▱▱▱▱▱▱▱▱▱▱` 8.81% |
| &nbsp;&nbsp;└ Game code (`src/*.c`, 48 modules) | 2006 | 326 | `▰▰▰▱▱▱▱▱▱▱▱▱▱▱▱▱▱▱▱▱` 16.25% |
