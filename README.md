...
<!-- PROGRESS:BADGE -->
![matched](https://img.shields.io/badge/matched-331%2F3713%20(8.91%25)-1f6feb)
<!-- /PROGRESS:BADGE -->
...
|---|---:|---:|---|
| **Main executable** (`KKND.EXE`) | 3713 | 331 | `▰▰▱▱▱▱▱▱▱▱▱▱▱▱▱▱▱▱▱▱` 8.91% |
| &nbsp;&nbsp;└ Game code (`src/*.c`, 48 modules) | 2006 | 330 | `▰▰▰▱▱▱▱▱▱▱▱▱▱▱▱▱▱▱▱▱` 16.45% |
| &nbsp;&nbsp;└ Libraries (`src/lib/`) | 1707 | 1 | `▱▱▱▱▱▱▱▱▱▱▱▱▱▱▱▱▱▱▱▱` 0.06% |
<!-- /PROGRESS:TABLE -->
