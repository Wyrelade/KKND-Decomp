...
<!-- PROGRESS:BADGE -->
![matched](https://img.shields.io/badge/matched-477%2F3713%20(12.85%25)-1f6feb)
<!-- /PROGRESS:BADGE -->
...
|---|---:|---:|---|
| **Main executable** (`KKND.EXE`) | 3713 | 477 | `▰▰▰▱▱▱▱▱▱▱▱▱▱▱▱▱▱▱▱▱` 12.85% |
| &nbsp;&nbsp;└ Game code (`src/*.c`, 48 modules) | 2006 | 474 | `▰▰▰▰▰▱▱▱▱▱▱▱▱▱▱▱▱▱▱▱` 23.63% |
