...
<!-- PROGRESS:BADGE -->
![matched](https://img.shields.io/badge/matched-360%2F3713%20(9.70%25)-1f6feb)
<!-- /PROGRESS:BADGE -->
...
|---|---:|---:|---|
| **Main executable** (`KKND.EXE`) | 3713 | 360 | `▰▰▱▱▱▱▱▱▱▱▱▱▱▱▱▱▱▱▱▱` 9.70% |
| &nbsp;&nbsp;└ Game code (`src/*.c`, 48 modules) | 2006 | 359 | `▰▰▰▰▱▱▱▱▱▱▱▱▱▱▱▱▱▱▱▱` 17.90% |
